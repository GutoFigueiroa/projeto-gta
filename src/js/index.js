...
Objetivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir uma caixa com os botões de seleção de plataforma
    ...
    Passo 4 - quando o usuário cliclar, adicionar a classe ativo na listagem de plataformas dentro do botão pra que o conteúdo apareça.

Objetivo 2 - caso a lista de botões de plataformas já esteja aparecendo e o usuário clicar no botão fechar, o conteúdo deve ser escondido.
